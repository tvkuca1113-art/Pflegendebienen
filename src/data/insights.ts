...
export const INSIGHTS: readonly Insight[] = [
  {
    ...
    dateISO: '2026-03-19',
    text: 'Ein Beitrag über eine gemeinsame Fortbildung im Büro. Die Veröffentlichung beschreibt, dass das Team zusammen wächst und dazulernt. Welcher Kurs oder Abschluss dahintersteht, geht aus dem Beitrag nicht hervor.',
  ...
  },
  {
    ...
    dateISO: '2026-03-23',
    text: 'Ein Treffen am gedeckten Tisch, veröffentlicht anlässlich von Bajram. Der Beitrag zeigt, dass im Team auch abseits der Einsätze gemeinsame Zeit stattfindet.',
  ...
  },
  {
    ...
    dateISO: '2026-03-10',
    text: 'Eine kurze gemeinsame Kaffeepause auf der Terrasse. Der Begleittext des Beitrags erwähnt, dass es danach wieder zu den Patientinnen und Patienten geht.',
...
export const ARCHIVE_INSIGHT: Insight = {
  ...
  dateISO: '2026-08-06',
  text: 'Geburtstagsgrüße an Laura und Sanja. Der Beitrag zeigt eine kleine gemeinsame Feier mit Blumen und Kuchen.',
